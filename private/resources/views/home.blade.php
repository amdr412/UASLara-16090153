            ...
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                        ...
                        <a href="/pemetaan-rambu" class="btn btn-sm btn-inverse-primary mr-3 mt-xl-0"> <i class="mdi mdi-home"></i>
                            Halaman Depan</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="media">
                            <img src="./public/images/undraw_world_9iqb.png" width="200" alt="">
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="media">
                            <img src="./public/images/undraw_map_light_6ttm.png" width="200" alt="">
                            <div class="media-body">
            ...
            <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="media">
                            <img src="./public/images/undraw_opened_gi4n.png" width="200" alt="">
                            <div class="media-body">
                                <p class="card-text">Melibatkan Masyarakat dengan fitur pelaporan masyarakatt</p>
                            </div>
                        </div>
                    </div>
                </div>
