...
<head>
    ...
    <link rel="shortcut icon" href="./publicimages/dishub.png">
    ...
    <header id="header" id="home">
        <div class="container main-menu">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.html"><img src="./publicimages/logo_navbar.png" alt="" title="" /></a>
                </div>
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="index.html">Beranda</a></li>
                        <li><a href="#layanan_masyarakat">Layanan Pelaporan</a></li>
    ...
    <script>
        ...
        function onLocationFound(e) {
            ...
            L.marker(e.latlng).addTo(map)
                .bindPopup("Anda Berada  " + radius + " meter dari titik ini ").openPopup();
